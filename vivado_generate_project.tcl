...
#
# Generated by Vivado on Sun Oct 24 11:20:18 EDT 2021
...
set files [list \
 ...
 [file normalize "${origin_dir}/ip/fifo_36_36_prim.xci"] \
]
...
set file "$origin_dir/ip/fifo_36_36_prim.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set_property -name "xsim.simulate.runtime" -value "500" -objects $obj
...
if {[string equal [get_runs -quiet synth_1_copy_1] ""]} {
    create_run -name synth_1_copy_1 -part xc7a35tcsg325-2 -flow {Vivado Synthesis 2020} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
set obj [get_runs synth_1_copy_1]
set_property -name "part" -value "xc7a35tcsg325-2" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/tlp-streamer.srcs/utils_1/imports/synth_1" -objects $obj
set_property -name "strategy" -value "Vivado Synthesis Defaults" -objects $obj
